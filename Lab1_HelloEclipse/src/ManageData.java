...
/**
 * The ManageData class inputs, outputs, and performs
analysis on an array of grade values. The input file
is assumed to include the number
 * off input values on the first line of input. Grades
are then followed, one on each line.
 *
...
public class ManageData {
	...
	private void swap(int[] TheArray, int A, int B) {
		...
		int temp;	//Temporary memory location needed to make the swap
